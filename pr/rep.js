...
function changeFrame(type, element) {
    ...
    let newSrc = "";
    switch (type) {
        case "calendar": if (sectionCalendar) sectionCalendar.classList.remove('hidden'); 
        break;
        case "task": if (sectionTask) sectionTask.classList.remove('hidden'); fetchTasks(); 
        break;
        case "verify":
        ...
        break;
        case "attendance": newSrc = "https://docs.google.com/forms/d/e/1FAIpQLSfXacHkUdWuQNvv1Pwcyx--NDFqFwjITTYL7672ZL6BG4-SgA/viewform?embedded=true"; 
        break;
        case "off": newSrc = "https://docs.google.com/forms/d/e/1FAIpQLSdgQKxcuAsomlhDX6yDsPI1s5O-x-u36-YPtHGGu-33QMMMCQ/viewform?embedded=true"; 
        break;
        case "ca": newSrc = "https://docs.google.com/forms/d/e/1FAIpQLSfhw4VyYKI9fc05UGtkvpRx0kIo98QRTKQsH_3NTpZAdzxi4w/viewform?embedded=true"; 
        break;
    }
